from api.parsers.grammars.g_labeled_trios_list import g_labeled_trios_list
from api import an_known_format as formats
import os
from random import uniform

class LabeledTriosList:
    ...
    def parse(self, data):
        ...
        val"salto"... """
        info = g_labeled_trios_list.parse(data)
        if info:
            formts=[]
            new_format=formats.LabeledTriosSeries(info)
    ...
    def help(self):
        ...
        donde y,z son valores numericos y x un label que seria el nombre del punto
                EJ: 
                [[label_0,5,1.2],[label_1,1,2.2]]
                [[label_2,1,2]]
                [[label_3,5.2,7],[label_4,6.2,3]]
                [[label_5,7.2,7],[label_6,8.2,3]]'''
    ...
    def data_generator(self,path ,amount=50, on_top=50, below=100):
        ...
        '''
        data_files = [item
                      for item in os.listdir(path) if item.__contains__("d_labeled_trios_list_")]
        file = open(path+"/d_labeled_trios_list_" +
        ...
        for item in range(0, amount):
            ...
            for x in range(0, num_of_elements):
                ...
                middle_data +="[label_"+str(labl_number)+","+elem_1+","+elem_2+"],"
                labl_number+=1
    ...
    def describe(self, line):
        ...
        retorna una None o una descripcioon del la line "LabeledTriosList" """
        info = g_labeled_trios_list.parse(line)
        if info:
            return "LabeledTriosList"
        return None
