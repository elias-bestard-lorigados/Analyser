...
def p_fourtuple(t):
    ''' fourtuple : OPEN_BRACKET LABEL COMMA NUM COMMA NUM COMMA NUM CLOSE_BRACKET COMMA fourtuple 
              | OPEN_BRACKET LABEL COMMA NUM COMMA NUM COMMA NUM CLOSE_BRACKET'''
    if len(t) == 10:
        t[0] = [[t[2], t[4],t[6],t[8]]]
    else:
